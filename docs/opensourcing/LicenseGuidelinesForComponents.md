...
A list of approved licenses and unapproved licenses for included snippets may be accessed [here](https://github.com/rdkcentral/docs/wiki/ROG_LicenseApprovals.md)
